					...
					<div id="s5jn" class="block">
						<div class="relative my-1 pb-9">
							<input type="email" id="email" name="email"
								...
								onfocus="document.getElementById('labelEmail').classList.add('top-2', '!text-[#000131]')"
								onblur="if(this.value==''){document.getElementById('labelEmail').classList.remove('top-2', '!text-[#000131]')}"
								required>
							<label for="email" id="labelEmail"
								class="absolute left-4 top-6 transform -translate-y-1 text-[13px] text-gray-400 transition-all duration-300 origin-0 select-none">E-mail</label>
							<!-- Validation -->
							<div id="errorEmail"
								class="select-none hidden text-red-500 font-medium text-[13px] px-1 my-1"></div>
						</div>
						<div class="flex gap-3 justify-end mt-16 pt-1.5">
							<button type="button" id="nextForgot"
					...
					<div id="s7jn" class="hidden">
						<div class="relative my-1">
							<input type="password" id="passwordForgot" name="password"
								...
								required>
							<label for="passwordForgot" id="labelForgotPassword"
								class="absolute left-4 top-6 transform -translate-y-1 text-[13px] text-gray-400 transition-all duration-300 origin-0 select-none">Senha</label>
							<!-- Validation -->
							<div id="errorEmail"
								class="select-none hidden text-red-500 font-medium text-[13px] px-1 my-1">Você precisa
								digitar um e-mail válido!</div>
						</div>
						<div class="relative my-1">
							<input type="password" id="passwordForgot2" name="password"
								...
								required>
							<label for="passwordForgot2" id="labelForgotConfirm"
								class="absolute left-4 top-6 transform -translate-y-1 text-[13px] text-gray-400 transition-all duration-300 origin-0 select-none">Confirme
								a Senha</label>
							<!-- Validation -->
							<div id="errorEmail"
								class="select-none hidden text-red-500 font-medium text-[13px] px-1 my-1">Você precisa
