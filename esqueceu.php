...
<body class="w-full h-full bg-gray-100">
				...
				<form method="POST">
					<div id="s5jn" class="block">
						<div class="relative my-1 pb-9">
							...
							<!-- Validation -->
							<div id="errorEmail" class="select-none hidden text-red-500 font-medium text-[13px] px-1 my-1">Você precisa digitar um e-mail válido!</div>
						</div>
					...
					<div id="s7jn" class="hidden">
						...
						<div class="flex gap-3 justify-end mt-8 pt-1.5">
							<button type="button" class="select-none text-[14px] px-4 w-fit bg-[#000131] text-white p-2 rounded-full font-medium border !border-[#000131] hover:bg-white hover:!text-[#000131] transition delay-75 duration-75">Seguinte</button>
						</div>
					</div>
				</form>
			</div>
	...
	<script src="<?= SITE_URL ?>/assets/js/recuperar_senha.js?v<?= time();?>"></script>
</body>
</html>