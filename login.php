      ...
      <div class="relative flex flex-col my-2 w-full !z-10">
        <form method="POST" id="loginForm" class="block">
          ...
          <div class="flex flex-col px-1 my-2">
            <a href="/esqueceu.php" id="sjw0" class="mb-3 text-[13px] hover:bg-[#0001310a] w-fit rounded-lg cursor-pointer font-semibold select-none">Esqueceu
              sua senha?</a>
          ...
          <div class="flex gap-3 justify-end mt-4">
            <div id="createAccount" class="select-none text-[14px] px-4 text-center w-fit hover:bg-[#0001311a] text-[#000131] p-2 rounded-full font-medium hover:!text-[#000131] transition delay-75 duration-75 cursor-pointer">
              Criar conta <div class="hidden absolute dropdown w-fit bg-[#c9c9e1] rounded-lg bottom-[-125px] right-[6.5rem] shadow-md">
              </div>
            </div>
        ...
        <form method="POST" id="registerBusiness" class="hidden">
          <div class="block" id="j22jn">
            <div class="relative my-1 mb-3" id="s2jn">
              ...
              <label for="name" id="labelName" class="absolute left-4 top-6 px-2 bg-white transform -translate-y-1 text-[12px] text-gray-400 transition-all duration-300 origin-0 select-none">Nome</label>
              <!-- Validation -->
            ...
            <div class="relative my-1 mb-3" id="s2jn">
              ...
              <label for="apelido" id="labelApelido" class="absolute left-4 top-6 px-2 bg-white transform -translate-y-1 text-[12px] text-gray-400 transition-all duration-300 origin-0 select-none">Apelido
                (opcional)</label>
              <!-- Validation -->
              <div id="errorApelido" class="hidden select-none text-red-500 font-medium text-[13px] px-1 my-1"></div>
            </div>
            <div class="relative my-1 mb-3" id="s2jn">
              <input type="text" id="email_usuario" placeholder="E-mail" name="email_usuario" class="w-full form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelEmail').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelEmail').classList.remove('!top-[-5px]', '!text-[#000131]')}" required>
              <!-- Validation -->
          ...
          <div class="hidden" id="j23jn">
            <div class="relative my-1 mb-3" id="s2jn">
              <input type="text" id="telefone" name="telefone" class="w-full md:w-[100%] form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelTelefone').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelTelefone').classList.remove('!top-[-5px]', '!text-[#000131]')}" required>
              <label for="telefone" id="labelTelefone" class="absolute left-4 top-6 px-2 bg-white transform -translate-y-1 text-[12px] text-gray-400 transition-all duration-300 origin-0 select-none">Telefone</label>
            ...
            <div class="relative my-1 mb-6" id="s2jn">
              <input type="email" id="email-secundario" name="email-secundario" class="w-full md:w-[100%] form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelEmailSecundario').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelEmailSecundario').classList.remove('!top-[-5px]', '!text-[#000131]')}">
              <label for="email-secundario" id="labelEmailSecundario" class="absolute left-4 top-6 px-2 bg-white transform -translate-y-1 text-[12px] text-gray-400 transition-all duration-300 origin-0 select-none">E-mail
            ...
            <div class="relative my-1 mb-3" id="s2jn">
              <input type="password" id="senha-registro" name="senha-registro" placeholder="Digite uma senha" class="w-full md:w-[100%] form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelSenha').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelSenha').classList.remove('!top-[-5px]', '!text-[#000131]')}" required>

              <div id="errorSenha" class="hidden select-none text-red-500 font-medium text-[13px] px-1 my-1"></div>
            </div>

            <div class="relative my-1 mb-3" id="s2jn">
              <input type="password" id="conf-senha" name="conf-senha" placeholder="Confirme sua senha" class="w-full md:w-[100%] form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelSenha').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelSenha').classList.remove('!top-[-5px]', '!text-[#000131]')}" required>
            ...
            <div class="relative my-1 mb-3" id="s2jn">
              <select id="tipoPessoa" name="tipoPessoa" class="w-full form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelTipoPessoa').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelTipoPessoa').classList.remove('!top-[-5px]', '!text-[#000131]')}" onchange="alterarTipoPessoa()" required>
                <option value="" disabled selected hidden></option>
                <option value="pf">Pessoa Física</option>
                <option value="pj">Pessoa Jurídica</option>
              </select>
              <label for="tipoPessoa" id="labelTipoPessoa" class="absolute left-4 top-6 px-2 bg-white transform -translate-y-1 text-[12px] text-gray-400 transition-all duration-300 origin-0 select-none">Tipo
                de documento</label>
            ...
            <div class="relative my-1 mb-6" id="s2jn">
              <input type="text" id="cpf" name="cpf" placeholder="CPF ex: 000.000.000-00" maxlength="11" class="w-full md:w-[100%] input-field-cpf form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelCpf').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelCpf').classList.remove('!top-[-5px]', '!text-[#000131]')}">
              <label for="cpf" id="labelCpf" class="absolute left-4 top-6 input-field-cpf px-2 bg-white transform -translate-y-1 text-[12px] text-gray-400 transition-all duration-300 origin-0 select-none">CPF</label>
            ...
            <div class="relative my-1 mb-6" id="s2jn">
              <input type="text" id="cnpj" name="cnpj" placeholder="CNPJ ex: 00.000.000/0000-00" maxlength="18" class="w-full md:w-[100%] input-field-cnpj form-control !outline-none pt-[1.03rem] p-3 text-[13px] text-[#47494d] font-medium shadow-none rounded-md border-2 border-[#eceeef] focus:border-[#000131]" onfocus="document.getElementById('labelCnpj').classList.add('!top-[-5px]', '!text-[#000131]')" onblur="if(this.value==''){document.getElementById('labelCnpj').classList.remove('!top-[-5px]', '!text-[#000131]')}">
            ...
            ?>
              <div class="h-captcha" data-sitekey="<?= $hCaptcha['site_key'] ?>"></div>
              <div id="errorCaptcha" class="hidden select-none text-red-500 font-medium text-[13px] px-1 my-1"></div>

            <?php } ?>
            <input type="hidden" id="razao_social" name="razao_social" />
            <input type="hidden" id="descricao_empresa" name="descricao_empresa" />


            <button type="button" id="concluirBtn" class="select-none text-[14px] px-4 w-fit bg-[#000131] text-white p-2 rounded-full font-medium border !border-[#000131] hover:bg-white hover:!text-[#000131] transition delay-75 duration-75 float-right right-0">Concluir</button>
          </div>
        </form>
      </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      document.getElementById('cnpj').addEventListener('input', function(e) {
        if (e.target.value === "") {
          let razaoSocialInput = document.getElementById('razao_social');
          let descricaoEmpresaInput = document.getElementById('descricao_empresa');
          razaoSocialInput.value = "";
          descricaoEmpresaInput.value = "";
        }
        ...
        if (e.target.value) {
          ...
          xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
              ...
              let razaoSocial = response.razao_social;
              let descricaoEmpresa = response.natureza_juridica.descricao;

              razaoSocialInput.value = razaoSocial;
              descricaoEmpresaInput.value = descricaoEmpresa;
            }
          };
          xhr.send();
        }
